...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager) {
        ...
        shiroFilterFactoryBean.setLoginUrl("/shiro/notLogin");
        // 设置无权限时跳转的 url;
        ...
        //开放登陆接口
        filterChainDefinitionMap.put("/api/web/v1/login", "anon");
        //开放验证码接口
        filterChainDefinitionMap.put("/api/web/v1/get_erify_code", "anon");
